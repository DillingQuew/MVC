...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 07 2023 г., 19:35
...
(69, 'insert', '2023-03-07 15:56:06', 12, 'Ярослав', 'Кочетов', 'Младший инженер', 15000);
...
(12, 'Ярослав', 'Кочетов', 'Младший инженер', 15000);
...
--
ALTER TABLE `log`
  ADD CONSTRAINT `log_ibfk_1` FOREIGN KEY (`row_id`) REFERENCES `Persons` (`Id`) ON DELETE CASCADE;
COMMIT;
